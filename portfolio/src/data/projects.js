export const projects = [
    {
      ...
      <div>
        <p>
          <strong>DEVCON Plus</strong> is a platform providing global opportunities, curated resources, and community-driven initiatives for Filipino developers.
        </p>

        <p>Product Design &amp; Frontend Development</p>
        <ul>
          <li>Designed and built a full product prototype in Figma for DEVCON Plus, defining its core experience and structure.</li>
          <li>Created a high-fidelity, clickable prototype focused on usability, navigation clarity, and design consistency aligned with DEVCON branding and ecosystem.</li>
          <li>Developed the frontend from the approved designs, translating Figma mockups into functional, responsive interfaces while iterating on design decisions based on mentor feedback and real organizational context.</li>
        </ul>
      </div>
      `,
      image: '/images/Devcon Plus.png',
      links: [
        {
          title: 'Demo Link',
          url: 'https://devcon.plus/'
        },
        {
          title: 'Github',
          url: 'https://github.com/cowniv/devcon-plus-rewards-hub'
        }
      ]
    },
    {
      ...
      <div>
        <p>
          <strong>Proyekto</strong> is a managed work delivery platform designed to streamline project execution through structured workflows and clear ownership.
        </p>

        <p>Frontend Development</p>
        <ul>
          <li>Developed and implemented frontend features for Proyekto, supporting structured workflows and clear ownership across project execution.</li>
          <li>Built responsive and scalable user interfaces using React (TanStack), ensuring a smooth user experience across core platform features.</li>
          <li>Translated complex workflow and milestone-based tracking requirements into intuitive UI components for clients and freelancers.</li>
          <li>Collaborated with backend developers to integrate APIs and support real-time collaboration features across the platform.</li>
        </ul>
      </div>
      `,
      image: '/images/Proyekto.png',
      links: [
        {
          title: 'Demo Link',
          url: 'https://www.proyekto.tech/'
        }
      ]
    },
    {
    ...
    {
      title: 'AWS DevTeam Project',
      description: `
      <div>
        <p>
          A website concept for <strong>PUP TEDx</strong>, designed as part of the <strong>AWS Cloud Club PUP DevTeam</strong>. Our team was tasked to craft the event&rsquo;s online presence, capturing the spirit of TEDx while keeping the experience clear and engaging for attendees.
        </p>

        <p>UI/UX Design Process</p>
        <p>
          As a member of the DevTeam, I contributed to the design direction of the website, following a user-centered approach:
        </p>
        <ul>
          <li><strong>Research &amp; Wireframing</strong> &mdash; Explored event-website patterns and structured low-fidelity wireframes to map out the layout and user flow.</li>
          <li><strong>High-Fidelity UI Design</strong> &mdash; Designed a bold, on-brand interface in Figma, aligning with the TEDx identity through strong typography, color, and imagery.</li>
          <li><strong>Responsive Layout</strong> &mdash; Ensured the design adapts cleanly across desktop and mobile so attendees can access event details anywhere.</li>
          <li><strong>Team Collaboration</strong> &mdash; Worked alongside fellow DevTeam members, iterating on the design to keep it consistent and implementation-ready.</li>
        </ul>
        <p>
          The result is a cohesive event website concept that reflects the energy of TEDx and the collaborative spirit of the AWS Cloud Club PUP DevTeam.
        </p>
      </div>
      `,
      ...
      links: [
        {
          title: 'Figma Link',
          url: 'https://www.figma.com/design/xhCu9w700TG4ep1I8Xn2nw/AWS-Devteam?node-id=2-3&t=IYRB9oAZWCK2Q2HP-1'
        }
      ]
    },
    {
      title: 'AWS Cloud Club PUP Website',
      description: `
      <div>
        <p>
          The official <strong>AWS Cloud Club PUP</strong> website. I served as the <strong>UI/UX designer for the Admin Side View</strong>, shaping the interface and experience of the platform&rsquo;s administrative dashboard.
        </p>

        <p>UI/UX Design Process</p>
        <p>
          Focusing on the admin experience, I designed an interface that makes managing the club&rsquo;s content and members straightforward:
        </p>
        <ul>
          <li><strong>Information Architecture</strong> &mdash; Structured the admin dashboard around clear workflows, organizing tools and data so they are easy to find and act on.</li>
          <li><strong>Functional UI Design</strong> &mdash; Designed clean, consistent layouts in Figma for management screens, tables, and forms, prioritizing clarity and efficiency.</li>
          <li><strong>Design System Consistency</strong> &mdash; Aligned the admin views with the website&rsquo;s overall branding and components for a unified look and feel.</li>
          <li><strong>Collaboration with Developers</strong> &mdash; Coordinated with the team to translate the designs into a functional, responsive admin interface.</li>
        </ul>
        <p>
          The result is an intuitive admin experience that supports the people running AWS Cloud Club PUP behind the scenes.
        </p>
      </div>
      `,
      image: '/images/AWS Website.png',
      links: [
        {
          title: 'Demo Link',
          url: 'https://www.awsccpup.cloud/'
        }
      ]
    },
    {
